      ...
      case Stage.FadeIn:
        return Container(
          ...
          margin: EdgeInsets.only(
            top: CurvedAnimation(
                    parent: animation as Animation<double>, curve: Curves.ease)
                .drive(Tween<double>(
                  begin: 170,
                  end: 70,
                ))
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color: Colors.white70
                          .withOpacity(.7 - animation!.value * .7),
                    ),
                  ),
                ],
              ),
              Stack(
                ...
                children: [
                  ...
                  Text(
                    'Fabrics',
                    textAlign: TextAlign.center,
                    textScaleFactor: 4 - animation!.value as double?,
                    style: TextStyle(
                      color: Colors.white
                          .withOpacity(1 - animation!.value as double),
                    ),
                  ),
                ],
              ),
