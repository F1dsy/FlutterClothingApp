...
CREATE TABLE ItemData(item_id INTEGER, temperature INTEGER, formality INTEGER, color TEXT, secondary_color TEXT, FOREIGN KEY(item_id) REFERENCES Items(id) ON DELETE CASCADE);
